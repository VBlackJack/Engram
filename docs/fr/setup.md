...
Engram exige Python 3.13+ et SQLite 3.51.3+ dans le module `sqlite3` de ce Python. Le moyen le plus
reproductible est le runtime Python 3.14.3 gere par `uv`, actuellement livre avec SQLite 3.53.3.
